      ...
      <div className="container">
        <TeamContent h2="Gary Bentz" p="Visionary/Strategic Ops" profile={img1}>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://www.linkedin.com/in/garybentz/"
          >
        ...
        <TeamContent h2="0xSethyk" p="Graphic Designer" profile={img3}>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://twitter.com/0xSethyk"
          >
        ...
        <TeamContent h2="Cpivet" p="Solidity Developer" profile={img4}>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://www.linkedin.com/in/ax-5bab1a198/"
          >
            <img src={linkedin} alt="linkedin" />
          </a>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://github.com/devneser"
          >
            <img src={github} alt="github" />
          </a>
        </TeamContent>
        ...
        <TeamContent h2="kokid951" p="Marketing Advisor" profile={img5}>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://twitter.com/kokid951"
          >
            <img src={twitter} alt="twitter" />
          </a>
        </TeamContent>
        ...
        <TeamContent h2="Angels" p="Collaboration Advisor" profile={img7}>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://twitter.com/xAngeels"
          >
            <img src={twitter} alt="twitter" />
          </a>
        </TeamContent>
        ...
        >
          <a
            target="_blank"
            rel="noreferrer"
            href="https://twitter.com/Baostronaut"
          >
            <img src={twitter} alt="twitter" />
          </a>
        </TeamContent>
      ...
      <div className="container">
        <TeamContent h2="Riku" p="Head Community Manager" profile={img9}>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://twitter.com/NoveltyRiku"
          >
            <img src={twitter} alt="twitter" />
          </a>
        </TeamContent>
        ...
        <TeamContent h2="Evobelle" p="Head Community Manager" profile={img10}>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://twitter.com/evo_belle"
          >
            <img src={twitter} alt="twitter" />
          </a>
        </TeamContent>
        ...
        <TeamContent h2="surferkiddo" p="Collaboration Council" profile={img11}>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://twitter.com/surferkiddo"
          >
            <img src={twitter} alt="twitter" />
          </a>
        </TeamContent>
        ...
        >
          <a
            target="_blank"
            rel="noreferrer"
            href="https://twitter.com/soluvlyyx"
          >
            <img src={twitter} alt="twitter" />
          </a>
        </TeamContent>
        ...
        <TeamContent h2="KingJDiddy" p="Security Advisor" profile={img13}>
          <a
            target="_blank"
            rel="noreferrer"
            href=" https://twitter.com/KingJDiddy_ETH"
          >
            <img src={twitter} alt="twitter" />
          </a>
        </TeamContent>
        ...
        <TeamContent h2="Tama" p="Moderator" profile={img14}>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://twitter.com/Tama_the_hodler"
          >
            <img src={twitter} alt="twitter" />
          </a>
        </TeamContent>
        ...
        <TeamContent h2="Rooks" p="Moderator" profile={img15}>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://twitter.com/Rooksmusic"
          >
            <img src={twitter} alt="twitter" />
          </a>
        </TeamContent>
        ...
        <TeamContent h2="Infiniti" p="Moderator" profile={img16}>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://twitter.com/infiniti_xyz"
          >
            <img src={twitter} alt="twitter" />
          </a>
        </TeamContent>
